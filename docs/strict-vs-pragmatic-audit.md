...
(The figc4.4/4.6/4.7 figure-defect quirks `Ax25Spec40/41/42/43/44/45/46/47` follow the identical pattern and live on the same `Ax25SessionQuirks` record - see the XML docs there and the §17 amendment log; not all are tabulated above.)
