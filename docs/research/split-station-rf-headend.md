...
`ISerialIo` (now `src/M0LTE.Tait.Ccdi/ISerialIo.cs` in the sibling repo
[`M0LTE/M0LTE.Tait.Ccdi`](https://github.com/M0LTE/M0LTE.Tait.Ccdi)), and there is already an injection point
