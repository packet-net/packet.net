...
export const APP_PACKAGES: AppPackage[] = [
  { id: "wall", name: "WALL", version: "1.2.0", description: "Shared message wall — leave a note for the next station", icon: "message-square", capabilities: ["session", "web"], enabled: true, source: "package", error: null, service: "managed", state: "Running", pid: 4711, detail: null, forwards: [] },
  { id: "lobby", name: "LOBBY", version: "0.9.1", description: "Multi-user chat lobby", icon: "users", capabilities: ["session"], enabled: false, source: "package", error: null, service: "managed", state: "Stopped", pid: null, detail: null, forwards: [] },
  { id: "quiz", name: "QUIZ", version: "2.0.0", description: "Trivia over packet", icon: null, capabilities: ["session"], enabled: true, source: "package", error: null, service: "managed", state: "Faulted", pid: null, detail: "exited 5 times in 30s (exit code 1) — giving up until restarted", forwards: [] },
  { id: "bbs-bridge", name: "BBS bridge", version: "0.3.0", description: "Bridges sessions to an externally-run BBS process", icon: null, capabilities: ["session"], enabled: true, source: "package", error: null, service: "external", state: "External", pid: null, detail: null, forwards: [] },
  { id: "wx", name: "wx", version: null, description: null, icon: null, capabilities: [], enabled: false, source: "package", error: "pdn-app.yaml: missing required field 'command'", service: "none", state: null, pid: null, detail: null, forwards: [] },
  { id: "motd", name: "MOTD", version: null, description: null, icon: null, capabilities: ["session"], enabled: true, source: "inline", error: null, service: "none", state: null, pid: null, detail: null, forwards: [] },
  { id: "notes", name: "Notes", version: "1.0.0", description: "Static node notice board — no service process", icon: "sticky-note", capabilities: [], enabled: false, source: "package", error: null, service: "none", state: null, pid: null, detail: null, forwards: [] },
