...
export const APP_PACKAGES: AppPackage[] = [
  { id: "wall", name: "WALL", version: "1.2.0", description: "Shared message wall — leave a note for the next station", icon: "message-square", capabilities: ["session", "web"], enabled: true, source: "package", error: null, service: "managed", state: "Running", pid: 4711, detail: null, forwards: [], command: "WALL", callsign: "M0ABC-1", pinnedCallsign: null, netromAlias: null, netromQuality: null },
  { id: "lobby", name: "LOBBY", version: "0.9.1", description: "Multi-user chat lobby", icon: "users", capabilities: ["session"], enabled: false, source: "package", error: null, service: "managed", state: "Stopped", pid: null, detail: null, forwards: [], command: "LOBBY", callsign: null, pinnedCallsign: null, netromAlias: null, netromQuality: null },
  { id: "quiz", name: "QUIZ", version: "2.0.0", description: "Trivia over packet", icon: null, capabilities: ["session"], enabled: true, source: "package", error: null, service: "managed", state: "Faulted", pid: null, detail: "exited 5 times in 30s (exit code 1) — giving up until restarted", forwards: [], command: "QUIZ", callsign: "M0ABC-2", pinnedCallsign: null, netromAlias: null, netromQuality: null },
  { id: "bbs-bridge", name: "BBS bridge", version: "0.3.0", description: "Bridges sessions to an externally-run BBS process", icon: null, capabilities: ["session"], enabled: true, source: "package", error: null, service: "external", state: "External", pid: null, detail: null, forwards: [], command: "BBS", callsign: "M0ABC-3", pinnedCallsign: "M0ABC-3", netromAlias: "RDGBBS", netromQuality: 255 },
  { id: "wx", name: "wx", version: null, description: null, icon: null, capabilities: [], enabled: false, source: "package", error: "pdn-app.yaml: missing required field 'command'", service: "none", state: null, pid: null, detail: null, forwards: [], command: null, callsign: null, pinnedCallsign: null, netromAlias: null, netromQuality: null },
  { id: "motd", name: "MOTD", version: null, description: null, icon: null, capabilities: ["session"], enabled: true, source: "inline", error: null, service: "none", state: null, pid: null, detail: null, forwards: [], command: "MOTD", callsign: null, pinnedCallsign: null, netromAlias: null, netromQuality: null },
  { id: "notes", name: "Notes", version: "1.0.0", description: "Static node notice board — no service process", icon: "sticky-note", capabilities: [], enabled: false, source: "package", error: null, service: "none", state: null, pid: null, detail: null, forwards: [], command: null, callsign: null, pinnedCallsign: null, netromAlias: null, netromQuality: null },
