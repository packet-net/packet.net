...
- [`M0LTE.Rig`](https://www.nuget.org/packages/M0LTE.Rig) - the `IRadioSideChannel` seam the SDM link rides
- [`M0LTE.Tait.Ccdi`](https://www.nuget.org/packages/M0LTE.Tait.Ccdi) - the Tait CCDI SDM side channel
