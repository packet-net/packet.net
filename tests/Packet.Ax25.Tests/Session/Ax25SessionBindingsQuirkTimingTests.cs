...
/// post-hoc guard wrappers stuck in whatever state the context had at
/// construction, while every other quirk followed the hook
/// (packet-net/packet.net#696). The ax25spec#40 wrapper was the other one covered
/// here; it retired when figc4.4/figc4.5 gained the window guard natively, so #43
/// is the remaining wrapper of that shape.
/// </summary>
