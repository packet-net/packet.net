...
/// <remarks>
/// <para>
/// figc4.6's page-level <c>save: [DL_DISCONNECT_request]</c> is not
/// asserted by this test — same caveat as figc4.2's smoke test. Posting
/// <see cref="DlDisconnectRequest"/> in this state goes to the unhandled-
/// event path, which is the expected behaviour until save machinery is
/// wired up.
/// </para>
/// <para>
/// Decision bindings needed: <c>P_eq_1</c>, <c>F_eq_1</c> (referenced by
/// both <c>ua_f_eq_1</c> and <c>dm_f_eq_1</c> diamonds), <c>V_s_eq_V_a</c>,
/// <c>RC_eq_N2</c>, and <c>layer_3_initiated</c> (used by two distinct
/// drawn diamonds: <c>data_layer_3_initiated</c> and
